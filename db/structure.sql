...
--
-- Name: fk_rails_4384ad32b4; Type: FK CONSTRAINT; Schema: map_datahub_ruz; Owner: -
--

ALTER TABLE ONLY corporate_body_mappings
    ADD CONSTRAINT fk_rails_4384ad32b4 FOREIGN KEY (corporate_body_id) REFERENCES datahub.corporate_bodies(id) ON DELETE SET NULL;


--
-- Name: fk_rails_b9792f9055; Type: FK CONSTRAINT; Schema: map_datahub_ruz; Owner: -
--
...
ALTER TABLE ONLY notices
    ADD CONSTRAINT fk_rails_b442791ca1 FOREIGN KEY (contract_id) REFERENCES contracts(id) ON DELETE CASCADE;
